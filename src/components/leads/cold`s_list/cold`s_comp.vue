...
div(:class="{ download: opacity }")
  vue-context(ref="menu", v-slot="{ data }")
    template(v-if="data")
      ...
      .context_cell(@click="clickDeleteLead(data.user)")
        ...
        span Remove
  UploadDialog(:vis='uploadDialogShow'   @close="uploadDialogShow = false")
  ...
  .table-footer
    ...
    .tf-right
      ...
      button.mass_resent(@click="uploadDialogShow = true" ) Upload File
      .tfr-input-box
        input(
...
import EditLeadDialog from "@/components/leads/cold`s_list/edit_dialog.vue"
import DeleteDialog from "@/components/leads/cold`s_list/delete_dialog.vue"
import UploadDialog from "@/components/leads/cold`s_list/upload_dialog.vue"
